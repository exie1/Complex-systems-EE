...
% p.location = pi/2*setPoints(3,pi/2); p.sigma2 = [1,1,1]*0.3; p.depth = payoffs(1,:);
p.location = pi/2*setPoints(4,3*pi/4);  p.sigma2 = [1,1,1,1]*0.3;  p.depth = payoffs(1,:);
...
[~,t,choices,spatial_FNS,~] = fHMC_MAB_sw(p,payoffs,1.5,1.5,0.5);
